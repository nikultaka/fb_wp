...
(function( $, window, document, undefined ) {
	...
	function _fnBuildAjax( oSettings, data, fn )
	{
		...
		if ( data.action == 'arf_retrieve_form_entry' || data.action == 'arf_retrieve_form_incomplete_entry' ) {
			var json_data = {
				"aoData": data
			}
			var filtered_data = "action=" + data.action + "&data=" + JSON.stringify( json_data );
			data = filtered_data;
		}
