...
class kode_extend_vc_addon_woo {
    function __construct() {
        // We safely integrate with VC with this hook
        //add_action( 'init', array( $this, 'kode_vc_notice' ) );
 
        // Use this when creating a shortcode addon
        add_shortcode( 'woo_item', array( $this, 'kode_print_element' ) );
        // Register CSS and JS
        ...
        vc_map(array(
            ...
            "params" => array(
				...
				array(
					'type' => 'dropdown',
					'heading' => __( 'Select Style', 'js_composer' ),
					'param_name' => 'woo_column_size',
					'value' => array(
						__( ' ', 'js_composer' ) => 'no-category',
						__('2 column', 'kickoff') => '2',
						__('3 column', 'kickoff') => '3',
						__('4 Column', 'kickoff') => '4',
					),
					'description' => __( 'Select Column.', 'js_composer' )
				),
				array(
					"type" => "textfield",
					"class" => "",
				...
				array(
					...
					"description" => __("Specify the number of woo description you want to pull out.", 'vc_extend')
				),
				array(
					'type' => 'dropdown',
