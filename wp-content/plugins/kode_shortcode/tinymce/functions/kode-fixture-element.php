...
class kode_extend_vc_addon_fixture {
    function __construct() {
        // We safely integrate with VC with this hook
        //add_action( 'init', array( $this, 'kode_vc_notice' ) );
 
        // Use this when creating a shortcode addon
        add_shortcode( 'fixture_item', array( $this, 'kode_print_element' ) );
        // Register CSS and JS
    ...
    public function kode_vc_notice() {
        ...
        */
        vc_map(array(
            "name" => __("Fixtures Item", 'vc_extend'),
            ...
            "params" => array(
				...
				array(
					'type' => 'dropdown',
					'heading' => __( 'Fixture Scope', 'js_composer' ),
					'param_name' => 'scope',
					'value' => array(
						__( ' ', 'js_composer' ) => 'no-category',
						__( 'Past Fixture', 'js_composer' ) => 'past',
						__( 'Upcoming Fixture', 'js_composer' ) => 'future',
						__( 'All Fixture', 'js_composer' ) => 'all',
					),
					'description' => __( 'Select Scope.', 'js_composer' )
				),
				array(
					"type" => "textfield",
					"class" => "",
    ...
    */
    public function kode_print_element( $atts, $content = null ) {
		...
		$output = '<div class="row">'.kode_get_fixture_item($settings).'</div>';
		return $output;
    }
    /*
...
new kode_extend_vc_addon_fixture();