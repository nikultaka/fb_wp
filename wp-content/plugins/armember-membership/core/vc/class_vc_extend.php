...
class ARMLITE_VCExtend {
    ...
    public function ARM_arm_form_html($settings, $value) {
        global $wpdb, $ARMember, $arm_slugs, $arm_shortcodes, $arm_members_class, $arm_global_settings, $arm_email_settings,  $arm_member_forms, $arm_subscription_plans;
        ...
        if ($this->is_membership_vdextend == 0) {
            ...
            ?>
            <link rel="stylesheet" href="<?php echo MEMBERSHIPLITE_URL; ?>/css/arm-font-awesome.css" />
            <link rel="stylesheet" href="<?php echo MEMBERSHIPLITE_URL; ?>/css/arm_tinymce.css" />
            ...
            vc_map(array(
                ...
                'params' => array(
                    array(
                        ...
                        'heading' => false,
                        'param_name' => 'title',
                        'value' => __('Edit Profile', 'ARMember'),
                        'description' => '&nbsp;',
                        'admin_label' => true
                    ),
                    array(
                        ...
                        'heading' => false,
                        'param_name' => 'message',
                        'value' => __('Your profile has been updated successfully.', 'ARMember'),
                        'description' => '&nbsp;',
                        'admin_label' => true
                    ),
                    array(
                    ...
                    array(
                        ...
                        'value' => __('View Profile','ARMember'),
                        'description' => '&nbsp;',
                        'admin_label' => true
                    ),
                    array(
    ...
    public function ARM_arm_edit_profile_html($settings, $value) {
        global $wpdb, $ARMember, $arm_slugs, $arm_shortcodes, $arm_members_class, $arm_global_settings, $arm_email_settings,  $arm_member_forms, $arm_subscription_plans,$arm_social_feature;
        ...
        if ($this->is_membership_vdextend == 0) {
            ...
            <?php endif; ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="title" class="wpb_vc_param_value" value="<?php _e('Edit Profile', 'ARMember'); ?>" id="arm_title" /></td>
                                            </tr>
                                            <tr>
                                                <th><?php _e('Message', 'ARMember'); ?></th>
                                                <td>
                                                    <input type="text" class="wpb_vc_param_value" name="message" value="<?php _e('Your profile has been updated successfully.', 'ARMember'); ?>" id="arm_message" />
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <label>
                                                        ...
                                                        <span><?php _e('View Profile','ARMember'); ?></span>
                                                    </label>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="wpb_vc_param_value" name="view_profile_link" value="<?php _e('View Profile', 'ARMember'); ?>" id="view_profile_link_label" />
                                                </td>
                                            </tr>
                                        </table>
                                    </form>
                                    ...
                                    <form onsubmit="return false;">
                                        <table class="arm_shortcode_option_table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="wpb_vc_param_value" name="redirect_to" value="<?php echo ARMLITE_HOME_URL; ?>" id="arm_redirect_to" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>
    ...
    public function ARM_arm_account_detail_html($settings, $value) {
        global $wpdb, $ARMember, $arm_slugs, $arm_shortcodes, $arm_members_class, $arm_global_settings, $arm_email_settings,  $arm_member_forms, $arm_subscription_plans,$arm_members_directory,$arm_social_feature;
