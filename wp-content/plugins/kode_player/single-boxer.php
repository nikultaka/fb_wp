			...
			<?php while ( have_posts() ){ the_post(); ?>
				<div class="kode-pagecontent">
					<div class="row">
						...
						<div class="col-md-8">
							<table class="kode-table">
								<caption><?php echo esc_attr(get_the_title())?> - <?php esc_html_e('Personal Info','kode-player')?></caption>
								<tbody>
									<tr>
										<td><?php esc_html_e('Date Of Birth','kode-player')?>:</td>
										<td><?php echo esc_attr($kode_post_option['date_of_birth'])?></td>
									</tr>
									<tr>
										<td><?php esc_html_e('Place Of Birth','kode-player')?>:</td>
										<td><?php echo esc_attr($kode_post_option['place_of_birth'])?></td>
									</tr>
									<tr>
										<td><?php esc_html_e('Nationality','kode-player')?>:</td>
										<?php $country = kode_get_country_array();?>
										<td><?php echo esc_attr($country[$kode_post_option['nationality']])?></td>
									</tr>
									<tr>
										<td><?php esc_html_e('Team','kode-player')?>:</td>
										<td><?php echo esc_attr(get_the_title($kode_post_option['select_national']))?></td>
									</tr>
									<tr>
										<td><?php esc_html_e('Height','kode-player')?>:</td>
										<td><?php echo esc_attr($kode_post_option['height'])?></td>
									</tr>
									<tr>
										<td><?php esc_html_e('Playing Position','kode-player')?>:</td>
				   ...
				   <div class="kode-detail-element">
					...
					<?php if(isset($kode_theme_option['player-table']) && $kode_theme_option['player-table'] == 'enable'){?>		
					<div class="team-detail-table-ap padding-bottom-30-flat">
						<h3><?php esc_html_e('Player Stats While Tournaments','kode-player')?></h3>
						<?php							
						...
						<table class="kode-table">
							<thead>
								<tr>
									<th class="player-name-sec"><?php esc_html_e('Player Name','kode-player')?></th>
									<th class="player-team-opp-sec"><?php esc_html_e('Opponent','kode-player')?></th>
									<th class="player-goal-sec"><?php esc_html_e('Goals','kode-player')?></th>
									<th class="player-assist-sec"><?php esc_html_e('Assist','kode-player')?></th>
									<th class="player-owngoal-sec"><?php esc_html_e('Own Goal','kode-player')?></th>
									<th class="player-penality-sec"><?php esc_html_e('Penalty','kode-player')?></th>
									<th class="player-pos-sec"><?php esc_html_e('Position','kode-player')?></th>
									<th class="player-yellow-sec"><?php esc_html_e('Yellow Card','kode-player')?></th>
									<th class="player-redcard-sec"><?php esc_html_e('Red Card','kode-player')?></th>
									<th class="player-team-league-sec"><?php esc_html_e('League','kode-player')?></th>
								</tr>
							</thead>
							<tbody>
							<?php 		
						...
						<div class="team_stats">
							<h3><?php esc_html_e('Tournaments Played In','kode-player')?></h3>
							<?php						
							...
							<table class="kode-table">
								<thead>
									<tr>
										<th class="league-name-first"><?php esc_html_e('Tournament','kode-player')?></th>
										<th class="league-team-first"><?php esc_html_e('Opponent','kode-player')?></th>
										<th class="league-team-score-first"><?php esc_html_e('Goals','kode-player')?></th>
										<th class="league-team-target-first"><?php esc_html_e('Shorts On Target','kode-player')?></th>
										<th class="league-team-ck-first"><?php esc_html_e('Corner Kicks','kode-player')?></th>
										<th class="league-team-rc-first"><?php esc_html_e('Yellow Cards','kode-player')?></th>
										<th class="league-possession-first"><?php esc_html_e('Passing Accuracy','kode-player')?></th>
									</tr>
								</thead>
								<tbody>
								<?php 		
