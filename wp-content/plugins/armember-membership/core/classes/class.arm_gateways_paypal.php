    ...
    class ARM_Paypal {
        ...
        function arm_immediate_cancel_paypal_payment($subscr_id, $user_id, $plan_id, $planData)
        {
            ...
            try{
                ...
                $ARMember->arm_write_response("Error in Paypal Result => ".json_encode($PayPalResult));
            ...
            {
                $ARMember->arm_write_response("Error in Paypal Plan Cancel => ".json_encode($e));
            }
        }
        ...
        function arm_generate_paypal_form($plan_action = 'new_subscription', $plan_id = 0, $entry_id = 0, $coupon_code = '', $form_type = 'new', $setup_id = 0, $payment_mode = 'manual_subscription') {
            global $wpdb, $ARMember, $arm_slugs, $arm_global_settings, $arm_subscription_plans,  $arm_payment_gateways, $arm_membership_setup, $is_free_manual;
            $paypal_form = '';
                    ...
                    $amount = str_replace(",", "", $amount); 
                        ...
                        if ($plan->is_recurring() && $payment_mode == 'auto_debit_subscription') {
                            ...
                            if ($is_trial && $plan_action == 'new_subscription' || $remained_days > 0) {
                                $plan_form_data .= '<input type="hidden" name="a1" value="' . $trial_amount . '" />';
                            ...
                            $plan_form_data .= "<input type='hidden' name='amount' value='" . $trial_amount . "' />";
                        } else {
        ...
        function arm_payment_gateway_form_submit_action($payment_gateway, $payment_gateway_options, $posted_data, $entry_id = 0) {
            global $wpdb, $ARMember, $arm_global_settings, $arm_subscription_plans, $arm_member_forms,  $payment_done, $arm_payment_gateways;
        ...
        function arm_paypal_api_handle_response() {
            global $wpdb, $ARMember, $arm_global_settings, $arm_members_class, $arm_subscription_plans, $arm_member_forms, $arm_payment_gateways, $arm_manage_communication, $payment_done;
