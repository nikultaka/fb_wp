...
class kode_extend_vc_addon_upcoming_event {
    function __construct() {
        // We safely integrate with VC with this hook
        //add_action( 'init', array( $this, 'kode_vc_notice' ) );
 
        // Use this when creating a shortcode addon
        add_shortcode( 'upcoming_event_item', array( $this, 'kode_print_element' ) );
        // Register CSS and JS
    ...
    */
    public function kode_print_element( $atts, $content = null ) {
		...
		$output = '<div class="row">'.kode_get_upcoming_event_item($settings).'</div>';
		return $output;
    }
    /*
...
new kode_extend_vc_addon_upcoming_event();