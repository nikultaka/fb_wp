	...
	<div class="content_wrapper arm_subscription_plans_content" id="content_wrapper">
		<div class="page_title">
			...
			<div class="arm_add_new_item_box">
				<a class="greensavebtn" href="<?php echo admin_url('admin.php?page='.$arm_slugs->manage_plans.'&action=new');?>"><img align="absmiddle" src="<?php echo MEMBERSHIPLITE_IMAGES_URL ?>/add_new_icon.png"><span><?php _e('Add New Plan', 'ARMember') ?></span></a>
			</div>
			    ...
			    <div id="armmainformnewlist">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="display arm_on_display" id="armember_datatable" style="visibility: hidden;">
					    ...
					    if (current_user_can('arm_manage_plans')) {
											$gridAction .= "<a href='" . $edit_link . "'><img src='".MEMBERSHIPLITE_IMAGES_URL."/grid_edit.png' onmouseover=\"this.src='".MEMBERSHIPLITE_IMAGES_URL."/grid_edit_hover.png';\" class='armhelptip' title='".__('Edit Plan','ARMember')."' onmouseout=\"this.src='".MEMBERSHIPLITE_IMAGES_URL."/grid_edit.png';\" /></a>";
											$gridAction .= "<a href='javascript:void(0)' onclick='showConfirmBoxCallback({$planID});'><img src='".MEMBERSHIPLITE_IMAGES_URL."/grid_delete.png' class='armhelptip' title='".__('Delete','ARMember')."' onmouseover=\"this.src='".MEMBERSHIPLITE_IMAGES_URL."/grid_delete_hover.png';\" onmouseout=\"this.src='".MEMBERSHIPLITE_IMAGES_URL."/grid_delete.png';\" /></a>";
