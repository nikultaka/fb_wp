...
class kode_extend_vc_addon_next_fixtures {
    function __construct() {
        // We safely integrate with VC with this hook
        //add_action( 'init', array( $this, 'kode_vc_notice' ) );
 
        // Use this when creating a shortcode addon
        add_shortcode( 'next_fixture_item', array( $this, 'kode_print_element' ) );
        // Register CSS and JS
        ...
        vc_map(array(
            ...
            "params" => array(
				array(
					"type" => "textfield",
					"class" => "",
					"heading" => __("Header Title Right", 'vc_extend'),
					"param_name" => "header_title",
					"value" => __(" ", 'vc_extend'),
					"description" => __("Header Title of right side.", 'vc_extend')
				),
				array(
					"type" => "textfield",
					"class" => "",
					"heading" => __("Header Description Right", 'vc_extend'),
					"param_name" => "header_description",
					"value" => __(" ", 'vc_extend'),
					"description" => __("Header Description of right side.", 'vc_extend')
				), 
				array(
					'type' => 'checkbox',
				...
				array(
					...
					"param_name" => "player_right_bg_image",
					"value" => __("", 'vc_extend'),
				...
				array(
					...
					"param_name" => "player_right_bg_color",
					"value" => __(" ", 'vc_extend'),
					"description" => __("", 'vc_extend')
				),
				array(
    ...
    */
    public function kode_print_element( $atts, $content = null ) {
		extract( shortcode_atts( array(        
			...
			'header_description' => '',
			'category' => '',
			'player_right_bg_image' => '',
			'player_right_bg_color' => '',
			'margin_bottom' => ''
		), $atts ) );
		...
		$settings['header-description'] = $header_description;
		$settings['player-right-bg-image'] = $player_right_bg_image;
		$settings['player-right-bg-color'] = $player_right_bg_color;
		$settings['margin-bottom'] = $margin_bottom;
		$output = '<div class="row">'.kode_get_upcomming_match_fixture_item($settings).'</div>';
		return $output;
    }
    /*
...
new kode_extend_vc_addon_next_fixtures();