<?php
global $wpdb, $ARMember, $arm_slugs, $arm_members_class, $arm_member_forms, $arm_global_settings, $arm_subscription_plans, $arm_payment_gateways;
...
$grid_columns = array(
    ...
    'arm_user_plan' => __('Member Plan', 'ARMember'),
...
// <![CDATA[
    ...
    function format(d,_wpnonce) {
        var response1 = '</div><div class="arm_child_row_div_'+d[3]+'"><img class="arm_load_user_plans" src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/arm_loader.gif" alt="<?php _e('Load More', 'ARMember'); ?>" style="  margin-left: 530px; padding: 10px;"></div>';
    ...
    function arm_load_membership_grid(is_filtered) {
        ...
        var nColVisCols = [];
        var arm_cols_vis = '<?php echo $arm_colvis; ?>';
        ...
        var oTables = jQuery('#armember_datatable').dataTable({
            ...
            "buttons":[{
                ...
                "text":"<span class=\"armshowhideicon\" style=\"background-image: url(<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/show_hide_icon.png);background-repeat: no-repeat;background-position: 0 center;padding: 0 0 0 30px;\">Show / Hide columns</span>",
    ...
    <form method="GET" id="arm_member_list_form" class="data_grid_list" onsubmit="return arm_member_list_form_bulk_action();">
        ...
        <div class="arm_datatable_filters">
            <div class="arm_dt_filter_block arm_datatable_searchbox">
                <label><input type="text" placeholder="<?php _e('Search Member', 'ARMember'); ?>" id="armmanagesearch_new" value="<?php echo $filter_search; ?>" tabindex="-1"></label>
