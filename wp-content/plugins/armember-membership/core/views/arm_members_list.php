	...
	<div class="content_wrapper" id="content_wrapper">
		<div class="page_title">
			...
			<div class="arm_add_new_item_box">
				<a class="greensavebtn" href="<?php echo admin_url('admin.php?page='.$arm_slugs->manage_members.'&action=new');?>"><img align="absmiddle" src="<?php echo MEMBERSHIPLITE_IMAGES_URL ?>/add_new_icon.png"><span><?php _e('Add Member', 'ARMember') ?></span></a>
			</div>
...
<div class="arm_member_manage_plan_detail_popup popup_wrapper arm_import_user_list_detail_popup_wrapper <?php echo (is_rtl()) ? 'arm_page_rtl' : ''; ?>" style="width:1000px; min-height: 200px;">
    <form method="GET" id="arm_member_manage_plan_user_form" class="arm_admin_form">
        <div>
            ...
            <div style="width: 100%; margin: 45px auto;">	<img src="<?php echo MEMBERSHIPLITE_IMAGES_URL."/arm_loader.gif"; ?>"></div>
