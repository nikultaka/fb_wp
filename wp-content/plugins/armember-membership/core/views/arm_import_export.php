					...
					<table class="form-table">
						<tr class="form-field">
							...
							<td class="arm-form-table-content">
								<select name="subscription_plan[]" id="subscription_plan_select" class="arm_chosen_selectbox" data-placeholder="<?php _e('Select Plan(s)..', 'ARMember');?>" multiple >
									<?php
									if (!empty($all_plans)) {
						...
						<tr class="form-field">
							...
							<td class="arm-form-table-content arm_import_export_date_fields">
								<input type="text" name="start_date" placeholder="<?php _e('Start Date', 'ARMember');?>" class="arm_datepicker">
								<input type="text" name="end_date" placeholder="<?php _e('End Date', 'ARMember');?>" class="arm_datepicker">
							</td>
						</tr>
                        <tr class="form-field">
					...
					<table class="form-table">
						...
						<tr class="form-field">
							...
							<td class="arm-form-table-content">
								...
								<button id="arm_user_import_btn" class="armemailaddbtn" name="arm_action" value="user_import" type="submit"><?php _e('Import', 'ARMember');?></button>&nbsp;<img src="<?php echo MEMBERSHIPLITE_IMAGES_URL.'/arm_loader.gif' ?>" class="arm_loader_img_import_user arm_submit_btn_loader" style="display:none;" width="24" height="24" />
							</td>
						</tr>
                        <tr class="form-field">
                            <td colspan="2">
        ...
        <div class="popup_wrapper_inner" style="overflow: hidden;">
            ...
            <div class="popup_content_btn popup_footer">
                ...
                <div class="popup_content_btn_wrapper">
                    <img src="<?php echo MEMBERSHIPLITE_IMAGES_URL . '/arm_loader.gif'; ?>" class="arm_loader_img arm_submit_btn_loader" style="top: 15px;display: none;float: <?php echo (is_rtl()) ? 'right' : 'left'; ?>;" width="20" height="20"/>
        ...
        <table  cellspacing="0">
            <tr>
                    ...
                    if (!empty($dbProfileFields['default'])) {
                        ...
                        foreach ($dbProfileFields['default'] as $fieldMetaKey => $fieldOpt) {
                            ...
                            <label class = "account_detail_radio arm_account_detail_options">
                                ...
                                <label for="arm_profile_field_input_<?php echo $fieldMetaKey; ?>"><?php echo $fieldOpt['label']; ?></label>
                ...
                <td class="popup_content_btn popup_footer">
                    <div class="popup_content_btn_wrapper">
                        <img src="<?php echo MEMBERSHIPLITE_IMAGES_URL . '/arm_loader.gif' ?>" id="arm_loader_img_clear_field" class="arm_loader_img arm_submit_btn_loader" style="top: 15px;float: <?php echo (is_rtl()) ? 'right' : 'left'; ?>;display: none;" width="20" height="20" />
