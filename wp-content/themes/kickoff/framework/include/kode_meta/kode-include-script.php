<?php
	...
	*/		
	...
	if( !class_exists('kode_include_script') ){
	
		class kode_include_script{
			...
			function register_scripts(){
				$this->script_list = apply_filters('kode_enqueue_scripts', $this->script_list);
			}
