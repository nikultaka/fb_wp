<?php
global $wpdb, $ARMember, $arm_global_settings, $arm_access_rules, $arm_drip_rules, $arm_subscription_plans, $arm_member_forms, $arm_social_feature;
                                ...
                                <span class="arm_info_text"><?php _e('Add Conditional Rules', 'ARMember'); ?></span><br/><br/>
                                    ...
                                    <li id="arm_login_conditional_redirection_box0" class="arm_login_conditional_redirection_box_div">
                                        ...
                                        <a class="arm_remove_login_redirection_condition" href="javascript:void(0)" data-index="0">
                                            <img src='<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/arm_close_icon.png' onmouseover="this.src='<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/arm_close_icon_hover.png';" onmouseout="this.src='<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/arm_close_icon.png';" />
                                        </a>
                                        <table>
                            ...
                            <td>  
                                <div class="arm_signup_conditional_redirection_main_div">
                                    ...
                                    <li id="arm_signup_conditional_redirection_box0" class="arm_signup_conditional_redirection_box_div">
                                        ...
                                        <a class="arm_remove_signup_redirection_condition" href="javascript:void(0)" data-index="0"><img src='<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/arm_close_icon.png' onmouseover="this.src='<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/arm_close_icon_hover.png';" onmouseout="this.src='<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/arm_close_icon.png';" /></a>
                                        <table>
                                        <tr>
                                    ...
                                    <li id="arm_signup_conditional_redirection_box<?php echo $ckey; ?>" class="arm_signup_conditional_redirection_box_div">
                                        ...
                                        <a class="arm_remove_signup_redirection_condition" href="javascript:void(0)" data-index="<?php echo $ckey; ?>"><img src='<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/arm_close_icon.png' onmouseover="this.src='<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/arm_close_icon_hover.png';" onmouseout="this.src='<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/arm_close_icon.png';" /></a>
                                        <table>
                                        <tr>
                                            <td width="135px"><?php _e('If SignUp form is', 'ARMember'); ?></td>
                                            <td>
                                ...
                                <tr class="form-field">
                                    ...
                                    <td class="arm_recstricted_page_post_redirection_input">
                                            ...
                                            <span class="arm_redirection_access_rules_non_loggedin_specific_error">
                                                <?php _e('The selected page is restricted item from access rule. Please select another page.', 'ARMember'); ?>
                                            </span>
...
<script>
    ...
    var   HOME_URL = '<?php echo ARMLITE_HOME_URL; ?>';
    ...
    var ARM_RR_CLOSE_IMG = '<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/arm_close_icon.png';
    var ARM_RR_CLOSE_IMG_HOVER = '<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/arm_close_icon_hover.png';
