                ...
                <div class="page_title">
                    <?php if ($isRegister) { ?>
                        ...
                        <div class="arm_header_registration_form_title">
                            ...
                            <input type="hidden" name="arm_forms[<?php echo $_REQUEST['form_id']; ?>][arm_form_label]" id="" class="arm_form_field_label_wrapper_value" value="<?php echo $form_label; ?>"/>
                        </div>
                    <?php } else { ?>
                        ...
                        <div class="arm_form_shortcode_container" style="<?php echo ($_GET['action'] == 'new_form') ? 'display:none;' : ''; ?>" >
                            ...
                            <span class="arm_form_shortcode arm_shortcode_text arm_form_shortcode_box">
                                ...
                                <span class="arm_copied_text arm_font_size_16">
                                    <img src="<?php echo MEMBERSHIPLITE_IMAGES_URL . '/copied_ok.png' ?>" />
                                                ...
                                                <ul class="arm_field_type_list"><?php
                                                    foreach ($user_meta_keys as $meta_key => $opts) {
                                                        if (strpos($meta_key, '_select_') == false) {
                                                            ...
                                                            ?><li class="frmfieldtypebutton arm_form_preset_fields <?php echo $fieldMetaClass; ?>" data-field_key="<?php echo $meta_key; ?>"><div class="arm_new_field"><a href="javascript:void(0);" id="<?php echo $meta_key; ?>"><img src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/general_icon.png" alt="<?php echo $opts['label']; ?>" /><img class="arm_disabled_img" src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/general_icon_disabled.png" alt="<?php echo $opts['label']; ?>" /><?php echo $opts['label']; ?></a></div></li><?php
                                                        }
                                                    }
                                                    ?></ul>
                                            </div>
                                            ...
                                            <ul class="arm_field_type_list">
                                                <li class="frmfieldtypebutton">
                                                    <div class="arm_new_field">
                                                        <a href="javascript:void(0);" id="text"><img src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/textbox_icon.png" alt="<?php _e('Textbox', 'ARMember'); ?>" /><?php _e('Textbox', 'ARMember'); ?></a>
                                                    </div>
                                                </li>
                                                <li class="frmfieldtypebutton">
                                                    <div class="arm_new_field">
                                                        <a href="javascript:void(0);" id="password"><img src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/password_icon.png" alt="<?php _e('Password', 'ARMember'); ?>"><?php _e('Password', 'ARMember'); ?></a>
                                                    </div>
                                                </li>
                                                <li class="frmfieldtypebutton">
                                                    <div class="arm_new_field">
                                                        <a href="javascript:void(0);" id="textarea"><img src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/textarea_icon.png" alt="<?php _e('Textarea', 'ARMember'); ?>" /><?php _e('Textarea', 'ARMember'); ?></a>
                                                    </div>
                                                </li>
                                                <li class="frmfieldtypebutton">
                                                    <div class="arm_new_field">
                                                        <a href="javascript:void(0);" id="checkbox"><img src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/checkbox_icon.png" alt="<?php _e('Checkbox', 'ARMember'); ?>" /><?php _e('Checkbox', 'ARMember'); ?></a>
                                                    </div>
                                                </li>
                                                <li class="frmfieldtypebutton">
                                                    <div class="arm_new_field">
                                                        <a href="javascript:void(0);" id="radio"><img src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/radio_icon.png" alt="<?php _e('Radio Buttons', 'ARMember'); ?>" /><?php _e('Radio Buttons', 'ARMember'); ?></a>
                                                    </div>
                                                </li>
                                                <li class="frmfieldtypebutton">
                                                    <div class="arm_new_field">
                                                        <a href="javascript:void(0);" id="select"><img src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/dropdown_icon.png" alt="<?php _e('Dropdown', 'ARMember'); ?>" /><?php _e('Dropdown', 'ARMember'); ?></a>
                                                    </div>
                                                </li>
                                                <li class="frmfieldtypebutton">
                                                    <div class="arm_new_field">
                                                        <a href="javascript:void(0);" id="date"><img src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/date_icon.png" alt="<?php _e('Date', 'ARMember'); ?>" /><?php _e('Date', 'ARMember'); ?></a>
                                                    </div>
                                                </li>
                                                <li class="frmfieldtypebutton">
                                                    <div class="arm_new_field">
                                                        <a href="javascript:void(0);" id="html"><img src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/html_text_icon.png" alt="<?php _e('Html Text', 'ARMember'); ?>" /><?php _e('Html Text', 'ARMember'); ?></a>
                                                    </div>
                                                </li>

                                                <li class="frmfieldtypebutton">
                                                    <div class="arm_new_field">
                                                        <a href="javascript:void(0);" id="file"><img src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/file_upload_icon.png" alt="<?php _e('File Upload', 'ARMember'); ?>" /><?php _e('File Upload', 'ARMember'); ?></a>
                                                    </div>
                                                </li>
                                                <li class="frmfieldtypebutton">
                                                    <div class="arm_new_field">
                                                        <a href="javascript:void(0);" id="section"><img src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/roles_icon.png" alt="<?php _e('Divider', 'ARMember'); ?>" /><?php _e('Divider', 'ARMember'); ?></a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="arm_form_addnew_fields_container">
                                            <ul class="arm_field_type_list">
                                                <li class="frmfieldtypebutton arm_form_preset_fields" data-field_key="roles">
                                                    <div class="arm_new_field">
                                                        <a href="javascript:void(0);" id="roles"><img src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/roles_icon.png" alt="<?php _e('Roles', 'ARMember'); ?>" /><img class="arm_disabled_img" src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/roles_icon_disabled.png" alt="<?php _e('Roles', 'ARMember'); ?>" /><?php _e('Roles', 'ARMember'); ?></a>
                                                    </div>
                                                </li>
                                                <li class="frmfieldtypebutton arm_form_preset_fields" data-field_key="avatar">
                                                    <div class="arm_new_field">
                                                        <a href="javascript:void(0);" id="avatar"><img src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/avatar_icon.png" alt="<?php _e('Avatar', 'ARMember'); ?>" /><img class="arm_disabled_img" src="<?php echo MEMBERSHIPLITE_IMAGES_URL; ?>/avatar_icon_disabled.png" alt="<?php _e('Avatar', 'ARMember'); ?>" /><?php _e('Avatar', 'ARMember'); ?></a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="arm_editor_form_fileds_wrapper armPageContainer" data-ng-module="ARMApp" data-ng-controller="ARMCtrl" data-ng-cloak="">
                                    ...
                                    <div class="page_title arm_form_heading_container arm_form_editor_form_heading <?php echo 'armalign' . $form_title_position; ?>" style="<?php echo ($form_settings['hide_title'] == '1') ? 'display:none;' : ''; ?>">
                                        ...
                                        <div class="arm_form_member_main_field_label arm_member_form_label">
                                            ...
                                            <?php if (!$isRegister) { ?>
                                                <input type="hidden" name="arm_forms[<?php echo $oformid; ?>][arm_form_label]" id="" class="arm_form_field_label_wrapper_value" value="<?php echo esc_html($oform['arm_form_title']); ?>"/>
                                            <?php } ?>

                                            <input type="hidden" name="arm_forms[<?php echo $oformid; ?>][arm_form_title]" id="arm_form_label_input_hidden" class="arm_form_field_label_wrapper_value" value="<?php echo esc_html($oform['arm_form_title']); ?>"/>
                                        </div>
                                        <div class="armclear"></div>
                    ...
                    <div class="arm_editor_right_wrapper tabs-container" id="tabs-container1">
                        ...
                        <div class="tab arm_form_settings_styles_container arm_width_100_pct" id="arm_form_settings_styles_container" >
                            <div id="tabsetting-1" class="arm-tab-content">
                                        ...
                                        <?php if (!$isRegister) { ?>
                                            ...
                                            <tr class="arm_registration_link_options <?php echo ($show_registration_link != '1') ? 'hidden_section' : ''; ?>">
                                                <td colspan="2">
                                                    ...
                                                    <div class="arm_form_opt_input">
                                                        ...
                                                        <span class="arm_info_text"><?php _e('To make partial part of sentance clickable, please use this pattrn', 'ARMember'); ?> <strong>[ARMLINK]</strong>xx<strong>[/ARMLINK]</strong></span>
                                                    </div>
                                                    <div class="armclear"></div>
                                                    <div class="arm_form_opt_input">
                                                        <?php
                                            ...
                                            <tr class="arm_registration_link_options <?php echo ($show_registration_link != '1') ? 'hidden_section' : ''; ?>">
                                                ...
                                                <td></td>
                                                       ...
                                                       <tr class="arm_registration_link_options <?php echo ($show_registration_link != '1') ? 'hidden_section' : ''; ?>">
                                                            <td colspan="2"><?php _e('Registration Link Margin', 'ARMember'); ?>
                                                            <?php
                                                        ...
                                                        <tr class="arm_forgot_password_link_options <?php echo ($show_forgot_password_link != '1') ? 'hidden_section' : ''; ?>">
                                                            <td colspan="2"><?php _e('Forgot Password Link Margin', 'ARMember'); ?>
                                        ...
                                        <?php if ($isRegister) { ?>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    ...
                                                    <div class="armswitch arm_global_setting_switch arm_vertical_align_middle">
                                                        <input type="checkbox" id="arm_auto_login_btn" <?php checked($auto_login, '1'); ?> value="1" class="armswitch_input armIgnore" name="arm_form_settings[auto_login]"/>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <div class="arm_form_opt_input">
                                                        ...
                                                        <?php /*<input type="text" name="arm_form_settings[forgot_password][description]" style="max-width:auto" value="<?php echo $forgotgePassDesc; ?>" id="arm_forgot_password_description_input" class="arm_forgot_password_description_input form_submit_action_input">*/ ?>
                                ...
                                <?php } ?>
                                <div class="arm_right_section_heading"><?php _e('Input Field Options', 'ARMember'); ?></div>
                                    ...
                                    <div class="arm_right_section_heading"><?php _e('Label Options', 'ARMember'); ?></div>
                                    <div class="arm_right_section_body arm_form_redirection_options">
                                    <table class="arm_form_settings_style_block">
                                                ...
                                                <div id="one" class="arm_accordion default">
                                                    <table class="arm_form_settings_style_block arm_tbl_label_left_input_right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="arm_right">
                                                                    <input type='text' id="arm_form_border_width" name="arm_form_settings[style][form_border_width]"  class="arm_form_width arm_form_setting_inpu arm_width_80" value="<?php echo isset($form_settings['style']['form_border_width']) ? $form_settings['style']['form_border_width'] : '0'; ?>" onkeydown="javascript:return checkNumber(event)" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div class="arm_right">
                                                                    ...
                                                                    <dl class="arm_selectbox column_level_dd">
                                                                        <dt class="arm_width_80 arm_min_width_50"><span></span><input type="text" style="display:none;" value="" class="arm_autocomplete"  /><i class="armfa armfa-caret-down armfa-lg"></i></dt>
                                                                        <dd>
                                                        ...
                                                        <tr class="arm_validation_message_position_container <?php echo ($formLayout == 'writer') ? 'hidden_section' : ''; ?>">
                                                ...
                                                <div id="three" class="arm_accordion">
                                                    <table class="arm_form_settings_style_block arm_tbl_label_left_input_right">
                                                        ...
                                                        <?php if ($isRegister) { ?>
                                                            ...
                                                            <tr>
                                                                <td class="font_settings_label"><?php _e('Hidden Fields', 'ARMember'); ?></td>
                                                                <td colspan="2"></td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="3">
                                                            ...
                                                            <tr class="arm_form_hidden_field_options <?php echo ($form_settings['is_hidden_fields'] == 1) ? '' : 'hidden_section'; ?>">
                                                                <td colspan="3">
                                                                        ...
                                                                        if (isset($form_settings['hidden_fields']) && !empty($form_settings['hidden_fields'])) {
                                                                            foreach ($form_settings['hidden_fields'] as $hkey => $hval) {
                                                                                ...
                                                                                <li class="arm_form_hidden_field" id="arm_form_hidden_field<?php echo $totalField; ?>">
                                                                                    <a href="javascript:void(0)" class="arm_remove_hidden_field" data-index="<?php echo $totalField; ?>">x</a>
                                                                                    <input type="hidden" name="arm_form_settings[hidden_fields][<?php echo $totalField; ?>][meta_key]" class="armIgnore" value="<?php echo (isset($hval['meta_key'])) ? $hval['meta_key'] : ''; ?>">
                                                                                    <div class="armclear"></div>
                                                                                    ...
                                                                                    <div class="armclear"></div>
                                                                                    <span><?php _e('Value', 'ARMember'); ?></span>
                                                                    ...
                                                                    <div class="arm_add_form_hidden_field_wrapper">
                                                                        <a class="arm_add_hidden_field_link" id="arm_add_hidden_field_link" href="javascript:void(0)" data-field_index="<?php echo $totalField; ?>">+ <?php _e('Add More', 'ARMember'); ?></a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
...
<?php if (!empty($form_detail)) { ?>
            ...
            jQuery(document).on('click', '#arm_save_member_form', function () {
                ...
                jQuery.ajax({
                    ...
                    url: __ARMAJAXURL,
                    dataType: 'json',
                    data: 'action=arm_save_member_forms&' + form_data,
...
<?php } ?>
    ...
    jQuery(document).on('click', '.arm_color_scheme_nav_link', function (e) {
      ...
      //  jQuery('#arm_form_settings_styles_container').animate({scrollTop: jQuery('#arm_color_scheme_container').position().top}, 0);
        jQuery('#arm_color_scheme_container').show();
    });
</script>