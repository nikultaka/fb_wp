...
/**
 * Testimonials Main Elementor Class
 *
 ...
 * @since 1.2.0
 */
final class Testimonials_Main_Init {
	...
	public function init() {
		...
		require_once( 'wp-elementor-model.php' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'CPT Testimonials', 'elementor-hello-world' ) . '</strong>',
	...
	public function admin_notice_minimum_elementor_version() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Elementor Testimonials', 'elementor-hello-world' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'elementor-hello-world' ) . '</strong>',
...
// Instantiate Testimonials_Main_Init.
new Testimonials_Main_Init();
