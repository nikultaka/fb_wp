...
function simple_php_captcha($config = array()) {
	...
	$bg_path = KODE_LOCAL_PATH . '/framework/include/frontend_assets/captcha/backgrounds/';
	$font_path = KODE_LOCAL_PATH . '/framework/include/frontend_assets/captcha/fonts/';
