...
final class Teams_Main_Init {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'CPT Teams', 'elementor-hello-world' ) . '</strong>',
	...
	public function admin_notice_minimum_elementor_version() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Elementor Team', 'elementor-hello-world' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'elementor-hello-world' ) . '</strong>',
