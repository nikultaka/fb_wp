...
class kode_extend_vc_addon_team {
    function __construct() {
        // We safely integrate with VC with this hook
        //add_action( 'init', array( $this, 'kode_vc_notice' ) );
 
        // Use this when creating a shortcode addon
        add_shortcode( 'team_item', array( $this, 'kode_print_element' ) );
        // Register CSS and JS
            ...
            "params" => array(
				...
				array(
					...
					'value' => array(
						...
						__( 'Normal View', 'kode-team' ) => 'normal-view',
						__( 'Modern View', 'kode-team' ) => 'modern-view',
					),
				...
				array(
					"type" => "textfield",
					"class" => "",
					"heading" => __("Num Excerpt", 'kode-team'),
					"param_name" => "num_excerpt",
					"value" => __("20", 'kode-team'),
					"description" => __("Specify the number of teams description you want to pull out.", 'kode-team')
				),
				array(
					'type' => 'dropdown',
    ...
    */
    public function kode_print_element( $atts, $content = null ) {
		...
		$settings['team-style'] = $team_style;
