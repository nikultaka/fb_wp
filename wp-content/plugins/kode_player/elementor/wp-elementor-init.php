...
final class Players_Main_Init {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'CPT Players', 'elementor-hello-world' ) . '</strong>',
	...
	public function admin_notice_minimum_elementor_version() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Elementor Player', 'elementor-hello-world' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'elementor-hello-world' ) . '</strong>',
...
// Instantiate Players_Main_Init.
new Players_Main_Init();
