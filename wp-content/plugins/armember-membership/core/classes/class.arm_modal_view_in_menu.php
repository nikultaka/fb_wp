...
if (!class_exists('ARM_modal_view_in_menu'))
{
    class ARM_modal_view_in_menu
    {
        ...
        function logout_from_menu_link()
        {
            ...
            $redirect_to = isset($_REQUEST['redirect_to']) ? $_REQUEST['redirect_to'] : ARMLITE_HOME_URL;
        ...
        function arm_add_nav_menu_metabox(){
            ...
            <style type="text/css">
                ...
                .armformnav .accordion-section-title.hndle::before{
                    background-image: url(<?php echo MEMBERSHIPLITE_IMAGES_URL.'/logo_navmenu_white.png' ?>);
                    height: 20px;
                    width: 20px;
                    content: " ";
                    position: absolute;
