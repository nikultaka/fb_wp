						...
						<?php foreach ($template_list as $key => $email_template) { ?>
							...
							<tr class="member_row_<?php echo $tempID; ?>">
								...
								<td class="armGridActionTD"><?php
									...
									$gridAction .= "<a class='arm_edit_template_btn' href='javascript:void(0);' data-temp_id='".$tempID."'><img src='".MEMBERSHIPLITE_IMAGES_URL."/grid_edit.png' onmouseover=\"this.src='".MEMBERSHIPLITE_IMAGES_URL."/grid_edit_hover.png';\" class='armhelptip' title='".__('Edit Message','ARMember')."' onmouseout=\"this.src='".MEMBERSHIPLITE_IMAGES_URL."/grid_edit.png';\" /></a>";
									$gridAction .= "</div>";
...
<?php if(!empty($messages)):?>
	...
	<div class="page_sub_content">
		...
		<div class="arm_add_new_item_box" style="margin: 0 0 20px 0;">			
			<a class="greensavebtn arm_add_new_message_btn arm_margin_right_40" href="javascript:void(0);" ><img align="absmiddle" src="<?php echo MEMBERSHIPLITE_IMAGES_URL ?>/add_new_icon.png"><span><?php _e('Add New Response', 'ARMember') ?></span></a>
		</div>
		<div class="armclear"></div>
		...
		<form method="GET" id="communication_list_form" class="data_grid_list arm_email_settings_wrapper" onsubmit="return apply_bulk_action_communication_list();return false;">
			...
			<div id="armmainformnewlist">
						...
						<tr class="arm_message_tr_<?php echo $messageID;?> row_<?php echo $messageID;?>">
							...
							switch ($rc->arm_message_type)
							{
								...
								case 'before_expire':
									...
									$msge_type = __('On Cancel Subscription', 'ARMember');
									break;
								default:
							...
							<td class="armGridActionTD"><?php
								...
								$gridAction = "<div class='arm_grid_action_btn_container'>";
								$gridAction .= "<a class='arm_edit_message_btn' href='javascript:void(0);' data-message_id='".$messageID."'><img src='".MEMBERSHIPLITE_IMAGES_URL."/grid_edit.png' onmouseover=\"this.src='".MEMBERSHIPLITE_IMAGES_URL."/grid_edit_hover.png';\" class='armhelptip' title='".__('Edit Message','ARMember')."' onmouseout=\"this.src='".MEMBERSHIPLITE_IMAGES_URL."/grid_edit.png';\" /></a>";
				...
				<input type="hidden" name="to_grid" id="to_grid" value="<?php _e('to', 'ARMember');?>"/>
				<input type="hidden" name="of_grid" id="of_grid" value="<?php _e('of', 'ARMember');?>"/>
				<input type="hidden" name="no_match_record_grid" id="no_match_record_grid" value="<?php _e('No matching messages found', 'ARMember');?>"/>
				<input type="hidden" name="no_record_grid" id="no_record_grid" value="<?php _e('There is no any communication message found.', 'ARMember');?>"/>
				<input type="hidden" name="filter_grid" id="filter_grid" value="<?php _e('filtered from', 'ARMember');?>"/>
				<input type="hidden" name="totalwd_grid" id="totalwd_grid" value="<?php _e('total', 'ARMember');?>"/>
				<?php wp_nonce_field( 'arm_wp_nonce' );?>
			</div>
			...
			<tr class="popup_wrapper_inner">	
				...
				<td class="popup_content_btn popup_footer">
					<div class="popup_content_btn_wrapper">
						<img src="<?php echo MEMBERSHIPLITE_IMAGES_URL.'/arm_loader.gif' ?>" id="arm_loader_img_temp" class="arm_loader_img arm_submit_btn_loader" style="top: 15px;display: none;float: <?php echo (is_rtl()) ? 'right' : 'left';?>;" width="20" height="20" />
