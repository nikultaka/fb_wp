...
class kode_extend_vc_addon_blog_list {
    function __construct() {
        // We safely integrate with VC with this hook
        //add_action( 'init', array( $this, 'kode_vc_notice' ) );
 
        // Use this when creating a shortcode addon
        add_shortcode( 'blog_list', array( $this, 'kode_print_element' ) );
        // Register CSS and JS
    ...
    public function kode_vc_notice() {
        ...
        */
        vc_map(array(
            "name" => __("Blog List Item", 'vc_extend'),
    ...
    */
    public function kode_print_element( $atts, $content = null ) {
		...
		$output = '<div class="row">'.kode_get_blog_list_normal_item($settings).'</div>';
		return $output;
    }
    /*
...
new kode_extend_vc_addon_blog_list();