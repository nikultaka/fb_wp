...
class kode_extend_vc_addon_news {
    function __construct() {
        // We safely integrate with VC with this hook
        //add_action( 'init', array( $this, 'kode_vc_notice' ) );
 
        // Use this when creating a shortcode addon
        add_shortcode( 'news_item', array( $this, 'kode_print_element' ) );
        // Register CSS and JS
            ...
            "params" => array(
				...
				array(
					...
					'value' => array(
						...
						__( 'News Grid', 'js_composer' ) => 'news-grid',
						__( 'News Medium', 'js_composer' ) => 'news-medium',
						__( 'News Timeline', 'js_composer' ) => 'news-timeline',
					),
				...
				array(
					...
					"description" => __("Specify the number of news you want to pull out.", 'vc_extend')
				),
				array(
					"type" => "textfield",
					"class" => "",
					...
					"description" => __("Specify the number of news description you want to pull out.", 'vc_extend')
				),
				array(
					'type' => 'dropdown',
    ...
    */
    public function kode_print_element( $atts, $content = null ) {
		...
		$settings['category'] = $news_category;
		$settings['tag'] = $news_tag;
		$settings['news-style'] = $news_style;
		$settings['num-fetch'] = $num_fetch;
		$settings['num-excerpt'] = $num_excerpt;
		$settings['orderby'] = $orderby;		
		$settings['order'] = $order;
		$settings['pagination'] = $pagination;
		$output = '<div class="row">'.kode_get_news_item($settings).'</div>';
		return $output;
    }
    /*
